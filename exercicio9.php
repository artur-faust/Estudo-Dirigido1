...
print  " \ n Deseja usar: 1 - Lata de 18 litros = custam 85 reais \ n              2 - Galão de 3,6 litros = custam 25 reais \ n              3 - Misturar galões e latas \ n     Selecione 1,2 ou 3: " ;
...
if ( $ lataougalao  ==  1 )
    { $ quantidadelitros =  $ tamanhom2pintar / 6 ;
     ...
     print  " \ n O preço vai ser: $ precolatas reais \ n Você vai comprar $ quantidadelatas latas " ;}
if ( $ lataougalao  ==  2 )
{    $ quantidadelitros =  $ tamanhom2pintar / 6 ;
    $ quantidadelitros =  ceil ( $ quantidadelitros );
    ...
    print  " \ n O preço vai ser: $ precogaloes reais \ n Você vai comprar $ quantidadegaloes galões " ;}
if ( $ lataougalao  ==  3 )
{    $ quantidadelitros =  $ tamanhom2pintar / 6 ;
    ...
    $ quantidadegaloes =  $ quantidadelitros / 3.6 ;
    $ quantidadegaloes =  ceil ( $ quantidadegaloes );
    if ( $ quantidadegaloes % 5 == 0  ou  $ quantidadegaloes > = 5 )
    ...
    if ( $ quantidadelatasda3 <= 0 ) / * Só pra ficar melhorzinho (mais bonito) * /
        ...
        / * A quantidade de latas / galões foram arredondadas para cima, pois você compra uma lata / galão inteiro * /
   print  " \ n rápido Você vai comprar: \ n $ quantidadegaloes galão (OES), custando $ precogaloes reais \ n $ quantidadelatasda3 lata (s) custando precolatas $ reais \ n Custando há total: $ custo_total reais " ;}
